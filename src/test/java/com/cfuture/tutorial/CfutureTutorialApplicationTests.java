...
@Slf4j
class CfutureTutorialApplicationTests {

    @Autowired
    CfutreTutorialService cfutreTutorialService;

    @Autowired
    private MockMvc mockMvc;

    @Test
    void 병렬실행_동기() throws Exception{
        ...
        CompletableFuture<String> apple = CompletableFuture.supplyAsync(() -> cfutreTutorialService.getString(param1));
        CompletableFuture<String> banana = CompletableFuture.supplyAsync(() -> cfutreTutorialService.getString(param2));
        CompletableFuture<String> tomato = CompletableFuture.supplyAsync(() -> cfutreTutorialService.getString(param3));
    ...
    void 병렬실행_예외() throws Exception{
        ...
        CompletableFuture<String> apple = CompletableFuture.supplyAsync(() ->
            cfutreTutorialService.getStringException(true, param1)
        ).exceptionally(e -> {
    ...
    void 비동기실행만하기() throws Exception{
        ...
        CompletableFuture.runAsync(() -> {
            String result = cfutreTutorialService.getString(param1);
            log.info("run apple : {}", result);
            countDownLatch.countDown();
        });
        CompletableFuture.runAsync(() -> {
            String result = cfutreTutorialService.getString(param2);
    ...
    void 예외또는결과(){
        ...
        CompletableFuture.runAsync(() -> {
            cfutreTutorialService.getString("apple");
        ...
        String s = CompletableFuture.supplyAsync(() -> {
                    String apple = cfutreTutorialService.getString("apple");
                    Random random = new Random();
                    boolean shouldThrowException = random.nextBoolean();
                    if(shouldThrowException){
                        throw new RuntimeException("강제예외");
