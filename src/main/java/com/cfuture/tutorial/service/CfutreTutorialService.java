package com.cfuture.tutorial.service;
...
@Service
@Slf4j
public class CfutreTutorialService {

    private final ThreadPoolTaskExecutor threadPoolTaskExecutor;

    public CfutreTutorialService(@Qualifier("secondThreadPool") ThreadPoolTaskExecutor threadPoolTaskExecutor) {
